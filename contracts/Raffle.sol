...
// Winner to be selcted every X mins -> completly automated
 ...
 * @dev This implments Chainlink VRF v2 and Chainlink Keepers
 */
contract Raffle is VRFConsumerBaseV2, KeeperCompatibleInterface {
    ...
    /**
     * @dev This is rhe func that ChainLink keep nodes call
     * The following should be true ino oder to return true:
